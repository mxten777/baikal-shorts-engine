...
4. **렌더링 시작** → FFmpeg 9:16 영상 생성 + 썸네일 자동 생성
5. **패키지 다운로드** → 비디오/썸네일 다운로드, 유튜브/인스타 업로드 패키지
...
### 🎬 자동 영상 생성
- 텍스트 입력만으로 30초 쇼츠 영상 자동 생성
- GPT-4o 기반 대본 작성 및 씬 분해
- OpenAI TTS를 통한 자연스러운 음성 합성
- FFmpeg 기반 전문적인 영상 렌더링

### 🖼️ 스마트 썸네일 생성
- **4가지 스타일 선택 가능**:
  - 🌈 **그라디언트**: 세련된 그라디언트 배경 + 글로우 효과
  - ⚡ **테크**: 기하학적 그리드 패턴
  - ✨ **미니멀**: 깔끔한 화이트 배경
  - 💪 **대담**: 강렬한 컬러 대비
- 텍스트 자동 줄바꿈 및 중앙 정렬
